...
public interface SellerTransactionResource extends BaseResource<SellerTransactionDTO> {
	...
	@GetMapping(value= {"/orders-for-seller-truckdriver/{truckDriverId}/{orderCreatedDate}"}, consumes = APPLICATION_JSON_VALUE, produces = APPLICATION_JSON_VALUE)
	public List<SellerOrder> getOrdersForSellerTruckDriver(@PathVariable("truckDriverId")Long truckDriverId, @PathVariable("orderCreatedDate") String orderCreatedDate);
