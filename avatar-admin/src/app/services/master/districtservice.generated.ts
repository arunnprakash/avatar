...
export class DistrictService {
    private get serviceBaseURL(): string {
        return this.serviceConfig.context + '/api/district';
    }
    ...
    public getAll(): Observable<DistrictDTO[]> {
        ...
        return this.httpClient.get<DistrictDTO[]>(url, {params: params})
    ...
    public save(arg0: DistrictDTO): Observable<DistrictDTO> {
        ...
        return this.httpClient.post<DistrictDTO>(url, arg0, {params: params})
            .pipe(catchError(this.handleError));
    }
    ...
    public update(arg0: DistrictDTO): Observable<DistrictDTO> {
        ...
        return this.httpClient.put<DistrictDTO>(url, arg0, {params: params})
            .pipe(catchError(this.handleError));
    }
