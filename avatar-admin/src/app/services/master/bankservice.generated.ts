...
import { BankDTO } from './bankdto.model';
...
export class BankService {
    private get serviceBaseURL(): string {
        return this.serviceConfig.context + '/api/bank';
    }

    constructor(private httpClient: HttpClient, private serviceConfig: ServiceConfig) { }
    /* GET */
    public getAll(): Observable<BankDTO[]> {
        const url = this.serviceBaseURL + '';
        const params = this.createHttpParams({});

        return this.httpClient.get<BankDTO[]>(url, {params: params})
            .pipe(catchError(this.handleError));
    }

    public getAllExceptDeleted(): Observable<BankDTO[]> {
    ...
    public get(id: number): Observable<BankDTO> {
    ...
    /* POST */
    public save(arg0: BankDTO): Observable<BankDTO> {
        const url = this.serviceBaseURL + '';
        const params = this.createHttpParams({});

        return this.httpClient.post<BankDTO>(url, arg0, {params: params})
            .pipe(catchError(this.handleError));
    }
    ...
    /* PUT */
    public update(arg0: BankDTO): Observable<BankDTO> {
        const url = this.serviceBaseURL + '';
        const params = this.createHttpParams({});

        return this.httpClient.put<BankDTO>(url, arg0, {params: params})
            .pipe(catchError(this.handleError));
    }
