...
export class SellerAgentCommissionService {
    ...
    /* GET */
    public getAll(): Observable<SellerAgentCommissionDTO[]> {
    ...
    public getAllExceptDeleted(): Observable<SellerAgentCommissionDTO[]> {
    ...
    public get(id: number): Observable<SellerAgentCommissionDTO> {
    ...
    /* POST */
    public save(arg0: SellerAgentCommissionDTO): Observable<SellerAgentCommissionDTO> {
        const url = this.serviceBaseURL + '';
        const params = this.createHttpParams({});
    ...
    /* PUT */
    public update(arg0: SellerAgentCommissionDTO): Observable<SellerAgentCommissionDTO> {
        const url = this.serviceBaseURL + '';
        const params = this.createHttpParams({});
