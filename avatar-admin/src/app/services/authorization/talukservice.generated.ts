...
export class TalukService {
    private get serviceBaseURL(): string {
        return this.serviceConfig.context + '/api/taluk';
    }
    ...
    public getAll(): Observable<TalukDTO[]> {
        ...
        return this.httpClient.get<TalukDTO[]>(url, {params: params})
    ...
    public save(arg0: TalukDTO): Observable<TalukDTO> {
        ...
        return this.httpClient.post<TalukDTO>(url, arg0, {params: params})
            .pipe(catchError(this.handleError));
    }
    ...
    public update(arg0: TalukDTO): Observable<TalukDTO> {
        ...
        return this.httpClient.put<TalukDTO>(url, arg0, {params: params})
            .pipe(catchError(this.handleError));
    }
