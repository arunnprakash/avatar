...
import { OutgoingSmsDTO } from './outgoingsmsdto.model';
 ...
 */
@Injectable()
export class OutgoingSmsService {
    ...
    /* GET */
    public getAll(): Observable<OutgoingSmsDTO[]> {
        const url = this.serviceBaseURL + '';
        const params = this.createHttpParams({});

        return this.httpClient.get<OutgoingSmsDTO[]>(url, {params: params})
            .pipe(catchError(this.handleError));
    }

    public getAllExceptDeleted(): Observable<OutgoingSmsDTO[]> {
    ...
    public get(id: number): Observable<OutgoingSmsDTO> {
    ...
    /* POST */
    public save(arg0: OutgoingSmsDTO): Observable<OutgoingSmsDTO> {
        const url = this.serviceBaseURL + '';
        const params = this.createHttpParams({});

        return this.httpClient.post<OutgoingSmsDTO>(url, arg0, {params: params})
            .pipe(catchError(this.handleError));
    }
    ...
    /* PUT */
    public update(arg0: OutgoingSmsDTO): Observable<OutgoingSmsDTO> {
        const url = this.serviceBaseURL + '';
        const params = this.createHttpParams({});

        return this.httpClient.put<OutgoingSmsDTO>(url, arg0, {params: params})
            .pipe(catchError(this.handleError));
    }
