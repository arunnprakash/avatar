...
@TypeScriptEndpoint("BankNameService")
@TypeScriptTemplatesConfiguration(useSuffixes = false)
@RequestMapping(value= {"/api/bankname"}, consumes = APPLICATION_JSON_VALUE, produces = APPLICATION_JSON_VALUE)
public interface BankNameResource extends BaseResource<BankNameDTO>{
