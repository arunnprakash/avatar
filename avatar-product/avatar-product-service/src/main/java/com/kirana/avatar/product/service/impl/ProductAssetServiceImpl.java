...
@Transactional
public class ProductAssetServiceImpl extends
		BaseServiceImpl<ProductAsset, ProductAssetDTO, ProductAssetMapper, ProductAssetRepository, ProductAssetSpecification>
		implements ProductAssetService {
	...
	public ProductAssetServiceImpl(ProductAssetRepository productAssetRepository, ProductAssetMapper productAssetMapper,
			ProductAssetSpecification productAssetSpecification) {
	...
	@Override
	protected Specification<ProductAsset> getSpecification(FilterCriteria filter,
			Specification<ProductAsset> specification) {
