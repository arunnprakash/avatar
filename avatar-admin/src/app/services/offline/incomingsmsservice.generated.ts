...
import { IncomingSmsDTO } from './incomingsmsdto.model';
...
export class IncomingSmsService {
    private get serviceBaseURL(): string {
        return this.serviceConfig.context + '/api/offline';
    }

    constructor(private httpClient: HttpClient, private serviceConfig: ServiceConfig) { }
    /* GET */
    public getAll(): Observable<IncomingSmsDTO[]> {
        const url = this.serviceBaseURL + '';
        const params = this.createHttpParams({});

        return this.httpClient.get<IncomingSmsDTO[]>(url, {params: params})
            .pipe(catchError(this.handleError));
    }

    public getAllExceptDeleted(): Observable<IncomingSmsDTO[]> {
    ...
    public get(id: number): Observable<IncomingSmsDTO> {
    ...
    /* POST */
    public save(arg0: IncomingSmsDTO): Observable<IncomingSmsDTO> {
        const url = this.serviceBaseURL + '';
        const params = this.createHttpParams({});

        return this.httpClient.post<IncomingSmsDTO>(url, arg0, {params: params})
            .pipe(catchError(this.handleError));
    }
    ...
    public receiveSms(resource: IncomingSmsDTO): Observable<boolean> {
        const url = this.serviceBaseURL + '/receive-sms';
        const params = this.createHttpParams({});

        return this.httpClient.post<boolean>(url, resource, {params: params})
            .pipe(catchError(this.handleError));
    }


    /* PUT */
    public update(arg0: IncomingSmsDTO): Observable<IncomingSmsDTO> {
        const url = this.serviceBaseURL + '';
        const params = this.createHttpParams({});

        return this.httpClient.put<IncomingSmsDTO>(url, arg0, {params: params})
            .pipe(catchError(this.handleError));
    }
