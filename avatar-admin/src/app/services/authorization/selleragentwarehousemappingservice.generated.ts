...
import { SellerAgentWareHouseMappingDTO } from './selleragentwarehousemappingdto.model';
 ...
 */
@Injectable()
export class SellerAgentWareHouseMappingService {
    private get serviceBaseURL(): string {
        return this.serviceConfig.context + '/api/selleragent-warehouse-mapping';
    }

    constructor(private httpClient: HttpClient, private serviceConfig: ServiceConfig) { }
    /* GET */
    public getAll(): Observable<SellerAgentWareHouseMappingDTO[]> {
        const url = this.serviceBaseURL + '';
        const params = this.createHttpParams({});

        return this.httpClient.get<SellerAgentWareHouseMappingDTO[]>(url, {params: params})
            .pipe(catchError(this.handleError));
    }

    public getAllExceptDeleted(): Observable<SellerAgentWareHouseMappingDTO[]> {
    ...
    public get(id: number): Observable<SellerAgentWareHouseMappingDTO> {
    ...
    /* POST */
    public save(arg0: SellerAgentWareHouseMappingDTO): Observable<SellerAgentWareHouseMappingDTO> {
        const url = this.serviceBaseURL + '';
        const params = this.createHttpParams({});

        return this.httpClient.post<SellerAgentWareHouseMappingDTO>(url, arg0, {params: params})
            .pipe(catchError(this.handleError));
    }
    ...
    /* PUT */
    public update(arg0: SellerAgentWareHouseMappingDTO): Observable<SellerAgentWareHouseMappingDTO> {
        const url = this.serviceBaseURL + '';
        const params = this.createHttpParams({});

        return this.httpClient.put<SellerAgentWareHouseMappingDTO>(url, arg0, {params: params})
            .pipe(catchError(this.handleError));
    }
