...
public class EndpointNodeFactory {
    ...
    private List<MethodNode> defineMethods(final TypeElement typeElement, final DeclaredType containingType) {
        ...
        System.out.println("Define Methods for Class " + typeElement + " by its superclass " + superclass);
        ...
        System.out.println("Define Methods for Class " + typeElement + " by its interfaces " + typeElement.getInterfaces());
        ...
        System.out.println("Define Methods for Class " + typeElement + " Own enclosed Methods " + ElementFilter.methodsIn(typeElement.getEnclosedElements()));
        ...
        ElementFilter.methodsIn(typeElement.getEnclosedElements()).stream()
                    ...
                    .forEach(superclassMethods::add);
        System.out.println("---defineMethods---");
