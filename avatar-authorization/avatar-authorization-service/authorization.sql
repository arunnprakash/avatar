...
INSERT INTO `users` (`created_by`, `created_date`, `deleted`, `last_modified_by`, `last_modified_date`, `version`, `dob`, `first_name`, `last_name`, `mobile_number`, `password`, `suspended`, `user_name`, `gender_id`, `language_id`, `village_id`) 
VALUES ('admin', NOW(), b'000000', 'admin', NOW(), '0', NOW(), 'admin', 'admin', '9566122460', '$2a$10$iVzLhHutaH8UhXXuv3E.S.vUFIxN0vA50pj2D8OC.r9nWKgtH7LsG', b'000000', 'admin', '1', '1', '1');
