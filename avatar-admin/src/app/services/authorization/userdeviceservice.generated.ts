...
export class UserDeviceService {
    private get serviceBaseURL(): string {
        return this.serviceConfig.context + '/api/userDevice';
    }

    constructor(private httpClient: HttpClient, private serviceConfig: ServiceConfig) { }
    /* GET */
    public getAll(): Observable<UserDeviceDTO[]> {
        const url = this.serviceBaseURL + '';
        const params = this.createHttpParams({});

        return this.httpClient.get<UserDeviceDTO[]>(url, {params: params})
            .pipe(catchError(this.handleError));
    }

    public getAllExceptDeleted(): Observable<UserDeviceDTO[]> {
    ...
    public get(id: number): Observable<UserDeviceDTO> {
    ...
    /* POST */
    public save(arg0: UserDeviceDTO): Observable<UserDeviceDTO> {
        const url = this.serviceBaseURL + '';
        const params = this.createHttpParams({});

        return this.httpClient.post<UserDeviceDTO>(url, arg0, {params: params})
            .pipe(catchError(this.handleError));
    }
    ...
    /* PUT */
    public update(arg0: UserDeviceDTO): Observable<UserDeviceDTO> {
        const url = this.serviceBaseURL + '';
        const params = this.createHttpParams({});

        return this.httpClient.put<UserDeviceDTO>(url, arg0, {params: params})
            .pipe(catchError(this.handleError));
    }
