...
import { SellerAgentCommissionDTO } from './selleragentcommissiondto.model';
 ...
 */
@Injectable()
export class SellerAgentCommissionService {
    private get serviceBaseURL(): string {
        return this.serviceConfig.context + '/api/seller-agent-commission';
    }

    constructor(private httpClient: HttpClient, private serviceConfig: ServiceConfig) { }
    /* GET */
    public getAllGet(): Observable<SellerAgentCommissionDTO[]> {
    ...
    public getAllExceptDeletedGet(): Observable<SellerAgentCommissionDTO[]> {
    ...
    public getGet(id: number): Observable<SellerAgentCommissionDTO> {
    ...
    public getLatestSellerAgentCommissionGet(): Observable<SellerAgentCommissionDTO> {
    ...
    /* POST */
    public savePost(arg0: SellerAgentCommissionDTO): Observable<SellerAgentCommissionDTO> {
        const url = this.serviceBaseURL + '';
        const params = this.createHttpParams({});

        return this.httpClient.post<SellerAgentCommissionDTO>(url, arg0, {params: params})
            .pipe(catchError(this.handleError));
    }
    ...
    /* PUT */
    public updatePut(arg0: SellerAgentCommissionDTO): Observable<SellerAgentCommissionDTO> {
        const url = this.serviceBaseURL + '';
        const params = this.createHttpParams({});

        return this.httpClient.put<SellerAgentCommissionDTO>(url, arg0, {params: params})
            .pipe(catchError(this.handleError));
    }
