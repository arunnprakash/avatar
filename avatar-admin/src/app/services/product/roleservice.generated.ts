...
export class RoleService {
    private get serviceBaseURL(): string {
        return this.serviceConfig.context + '/api/role';
    }
    ...
    public getAll(): Observable<RoleDTO[]> {
        ...
        return this.httpClient.get<RoleDTO[]>(url, {params: params})
            .pipe(catchError(this.handleError));
    }

    public getAllExceptDeleted(): Observable<RoleDTO[]> {
    ...
    public get(id: number): Observable<RoleDTO> {
    ...
    /* POST */
    public save(arg0: RoleDTO): Observable<RoleDTO> {
        const url = this.serviceBaseURL + '';
        const params = this.createHttpParams({});

        return this.httpClient.post<RoleDTO>(url, arg0, {params: params})
            .pipe(catchError(this.handleError));
    }
    ...
    /* PUT */
    public update(arg0: RoleDTO): Observable<RoleDTO> {
        const url = this.serviceBaseURL + '';
        const params = this.createHttpParams({});

        return this.httpClient.put<RoleDTO>(url, arg0, {params: params})
            .pipe(catchError(this.handleError));
    }
