...
export class BankAccountService {
    private get serviceBaseURL(): string {
        return this.serviceConfig.context + '/api/bank-account';
    }
    ...
    public getAll(): Observable<BankAccountDTO[]> {
        ...
        return this.httpClient.get<BankAccountDTO[]>(url, {params: params})
            .pipe(catchError(this.handleError));
    }

    public getAllExceptDeleted(): Observable<BankAccountDTO[]> {
    ...
    public get(id: number): Observable<BankAccountDTO> {
    ...
    /* POST */
    public save(arg0: BankAccountDTO): Observable<BankAccountDTO> {
        const url = this.serviceBaseURL + '';
        const params = this.createHttpParams({});

        return this.httpClient.post<BankAccountDTO>(url, arg0, {params: params})
            .pipe(catchError(this.handleError));
    }
    ...
    /* PUT */
    public update(arg0: BankAccountDTO): Observable<BankAccountDTO> {
        const url = this.serviceBaseURL + '';
        const params = this.createHttpParams({});

        return this.httpClient.put<BankAccountDTO>(url, arg0, {params: params})
            .pipe(catchError(this.handleError));
    }
