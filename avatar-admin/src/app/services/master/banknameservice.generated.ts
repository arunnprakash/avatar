...
export class BankNameService {
    private get serviceBaseURL(): string {
        return this.serviceConfig.context + '/api/bankname';
    }

    constructor(private httpClient: HttpClient, private serviceConfig: ServiceConfig) { }
    /* GET */
    public getAll(): Observable<BankNameDTO[]> {
        const url = this.serviceBaseURL + '';
        const params = this.createHttpParams({});

        return this.httpClient.get<BankNameDTO[]>(url, {params: params})
            .pipe(catchError(this.handleError));
    }

    public getAllExceptDeleted(): Observable<BankNameDTO[]> {
    ...
    public get(id: number): Observable<BankNameDTO> {
    ...
    /* POST */
    public save(arg0: BankNameDTO): Observable<BankNameDTO> {
        const url = this.serviceBaseURL + '';
        const params = this.createHttpParams({});

        return this.httpClient.post<BankNameDTO>(url, arg0, {params: params})
            .pipe(catchError(this.handleError));
    }
    ...
    /* PUT */
    public update(arg0: BankNameDTO): Observable<BankNameDTO> {
        const url = this.serviceBaseURL + '';
        const params = this.createHttpParams({});

        return this.httpClient.put<BankNameDTO>(url, arg0, {params: params})
            .pipe(catchError(this.handleError));
    }
