...
public interface UserResource extends BaseResource<UserDTO> {
	...
	@GetMapping(value= {"/seller/{sellerId}/seller-agent"}, consumes = APPLICATION_JSON_VALUE, produces = APPLICATION_JSON_VALUE)
	public UserDTO getSellerAgentForSeller(@PathVariable("sellerId") Long sellerId);
	
	@GetMapping(value= {"/buyer/{buyerId}/buyer-agent"}, consumes = APPLICATION_JSON_VALUE, produces = APPLICATION_JSON_VALUE)
	...
	@GetMapping(value= {"/seller-agent/warehouse/{wareHouseId}"}, consumes = APPLICATION_JSON_VALUE, produces = APPLICATION_JSON_VALUE)
	public List<UserDTO> getSellerAgentByWareHouse(@PathVariable("wareHouseId") Long wareHouseId);

	@GetMapping(value= {"/seller-agent/{sellerAgentId}/seller"}, consumes = APPLICATION_JSON_VALUE, produces = APPLICATION_JSON_VALUE)
	public List<UserDTO> getSellersBySellerAgent(@PathVariable("sellerAgentId") Long sellerAgentId);
