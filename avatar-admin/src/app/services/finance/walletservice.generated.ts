...
import { WalletDTO } from './walletdto.model';
...
export class WalletService {
    private get serviceBaseURL(): string {
        return this.serviceConfig.context + '/api/wallet';
    }

    constructor(private httpClient: HttpClient, private serviceConfig: ServiceConfig) { }
    /* GET */
    public getAll(): Observable<WalletDTO[]> {
    ...
    public getAllExceptDeleted(): Observable<WalletDTO[]> {
    ...
    public get(id: number): Observable<WalletDTO> {
    ...
    /* POST */
    public save(arg0: WalletDTO): Observable<WalletDTO> {
        const url = this.serviceBaseURL + '';
        const params = this.createHttpParams({});

        return this.httpClient.post<WalletDTO>(url, arg0, {params: params})
            .pipe(catchError(this.handleError));
    }
    ...
    /* PUT */
    public update(arg0: WalletDTO): Observable<WalletDTO> {
        const url = this.serviceBaseURL + '';
        const params = this.createHttpParams({});

        return this.httpClient.put<WalletDTO>(url, arg0, {params: params})
            .pipe(catchError(this.handleError));
    }
