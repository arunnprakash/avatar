...
@Entity
@Table(name = "selleragent_truckdriver_mapping")
@Getter
@Setter
...
public class SellerAgentTruckDriverMapping extends BaseEntity<SellerAgentTruckDriverMapping> {
	@ManyToOne(optional = false, fetch = FetchType.EAGER)
	@JoinColumn(name = "seller_agent_id", referencedColumnName = "id", nullable = false)
