...
/**
 * Concrete Factory for {@link PagingAndFilterResponseTypeNode}.
 */
class PagingAndFilterResponseTypeNodeFactory implements ConcreteTypeNodeFactory {
     ...
     */
    PagingAndFilterResponseTypeNodeFactory() {
        typeNodeFactory = null;
        objectMirror = null;
    }

    private PagingAndFilterResponseTypeNodeFactory(final TypeNodeFactory typeNodeFactory, final Elements elementUtils) {
    ...
    public ConcreteTypeNodeFactory newConfiguredInstance(final TypeNodeFactory typeNodeFactory, final TemplateConfiguration configuration, final Types typeUtils, final Elements elementUtils) {
        return new PagingAndFilterResponseTypeNodeFactory(typeNodeFactory, elementUtils);
    }
    ...
    public TypeNode createTypeNode(final String fieldName, final String parameterName, final boolean optional, final TypeMirror typeMirror, final DeclaredType containingType) {
        ...
        return new PagingAndFilterResponseTypeNode(optional, componentType);
    }
    ...
    private final class PagingAndFilterResponseTypeNode extends TypeNode {

        private final TypeNode containingType;

        private PagingAndFilterResponseTypeNode(final boolean optional, final TypeNode containingType) {
            super(optional);
